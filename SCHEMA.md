...
- Actions (non-conversational side effects fired on this exit)
- Next flow
...
- `tool` step type (external capability calls) — added in v1.
...
v1 extends v0 with structured step sequencing, per-turn captures, typed variable declarations, and step types for tool calls and sub-flow invocation. All v1 additions are purely additive.
